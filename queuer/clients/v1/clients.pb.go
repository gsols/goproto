...
type StoreClientStatsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StoreClientStatsRequest) Reset() {
	*x = StoreClientStatsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *StoreClientStatsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StoreClientStatsRequest) ProtoMessage() {}

func (x *StoreClientStatsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_queuer_clients_v1_clients_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StoreClientStatsRequest.ProtoReflect.Descriptor instead.
func (*StoreClientStatsRequest) Descriptor() ([]byte, []int) {
	return file_queuer_clients_v1_clients_proto_rawDescGZIP(), []int{2}
}

func (x *StoreClientStatsRequest) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *StoreClientStatsRequest) GetStats() *v1.Stats {
	if x != nil {
		return x.Stats
	}
	return nil
...
type StoreClientStatsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StoreClientStatsResponse) Reset() {
	*x = StoreClientStatsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *StoreClientStatsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StoreClientStatsResponse) ProtoMessage() {}

func (x *StoreClientStatsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_queuer_clients_v1_clients_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StoreClientStatsResponse.ProtoReflect.Descriptor instead.
func (*StoreClientStatsResponse) Descriptor() ([]byte, []int) {
	return file_queuer_clients_v1_clients_proto_rawDescGZIP(), []int{3}
}

func (x *StoreClientStatsResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_queuer_clients_v1_clients_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x75, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x21, 0x71, 0x75, 0x65,
	0x75, 0x65, 0x72, 0x2f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x2f, 0x76, 0x31, 0x2f,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1e,
	0x71, 0x75, 0x65, 0x75, 0x65, 0x72, 0x2f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x2f,
	0x76, 0x31, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4b,
	...
	,
	...
	0x12, 0x7d, 0x0a, 0x0e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x12, 0x28, 0x2e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x72, 0x2e, 0x63, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x43,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x71,
	0x75, 0x65, 0x75, 0x65, 0x72, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x76, 0x31,
	...
	0x01, 0x2a, 0x22, 0x0b, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x12,
	0x97, 0x01, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53,
	0x74, 0x61, 0x74, 0x73, 0x12, 0x2a, 0x2e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x72, 0x2e, 0x63, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x2b, 0x2e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x72, 0x2e, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	0x73, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	...
	0x7d, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x73, 0x28, 0x01, 0x42, 0x2f, 0x5a, 0x2d, 0x67, 0x69, 0x74,
...
var file_queuer_clients_v1_clients_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_queuer_clients_v1_clients_proto_goTypes = []interface{}{
	...
	(*StoreClientStatsRequest)(nil),  // 2: queuer.clients.v1.StoreClientStatsRequest
	(*StoreClientStatsResponse)(nil), // 3: queuer.clients.v1.StoreClientStatsResponse
	(*v1.Client)(nil),                // 4: queuer.entities.v1.Client
	(*v1.Stats)(nil),                 // 5: queuer.entities.v1.Stats
}
var file_queuer_clients_v1_clients_proto_depIdxs = []int32{
	4, // 0: queuer.clients.v1.RegisterClientRequest.client:type_name -> queuer.entities.v1.Client
	5, // 1: queuer.clients.v1.StoreClientStatsRequest.stats:type_name -> queuer.entities.v1.Stats
	0, // 2: queuer.clients.v1.ClientService.RegisterClient:input_type -> queuer.clients.v1.RegisterClientRequest
	2, // 3: queuer.clients.v1.ClientService.StoreClientStats:input_type -> queuer.clients.v1.StoreClientStatsRequest
	1, // 4: queuer.clients.v1.ClientService.RegisterClient:output_type -> queuer.clients.v1.RegisterClientResponse
	3, // 5: queuer.clients.v1.ClientService.StoreClientStats:output_type -> queuer.clients.v1.StoreClientStatsResponse
...
func file_queuer_clients_v1_clients_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_queuer_clients_v1_clients_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StoreClientStatsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_queuer_clients_v1_clients_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StoreClientStatsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
