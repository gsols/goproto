...
type GetOwnersResponse struct {
	...
	Owners []*v1.Owner `protobuf:"bytes,1,rep,name=owners,proto3" json:"owners,omitempty"`
}
...
func (x *GetOwnersResponse) GetOwners() []*v1.Owner {
	if x != nil {
		return x.Owners
	}
	return nil
...
type RegisterConsumerResponse struct {
	...
	IssuedToken string `protobuf:"bytes,1,opt,name=issued_token,json=issuedToken,proto3" json:"issued_token,omitempty"`
}
...
func (x *RegisterConsumerResponse) GetIssuedToken() string {
	if x != nil {
		return x.IssuedToken
	}
	return ""
}
...
func (x *GetConsumersRequest) Reset() {
	*x = GetConsumersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_queuer_owners_v1_messages_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetConsumersRequest) Descriptor() ([]byte, []int) {
	return file_queuer_owners_v1_messages_proto_rawDescGZIP(), []int{10}
}
...
func (x *GetConsumersResponse) Reset() {
	*x = GetConsumersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_queuer_owners_v1_messages_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetConsumersResponse) Descriptor() ([]byte, []int) {
	return file_queuer_owners_v1_messages_proto_rawDescGZIP(), []int{11}
}
...
var file_queuer_owners_v1_messages_proto_rawDesc = []byte{
	...
	0x31, 0x2f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x57,
	...
	0x88, 0x01, 0x01, 0x12, 0x1b, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x64, 0x22, 0x46, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2f,
	...
	0x76, 0x31, 0x2e, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x22,
	0x36, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	0x72, 0x49, 0x64, 0x22, 0x4b, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x74, 0x72, 0x65, 0x61,
	...
	0x22, 0x69, 0x0a, 0x17, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x73,
	0x75, 0x6d, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x08, 0x6f,
	...
	0x0a, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x49, 0x64, 0x22, 0x3d, 0x0a, 0x18, 0x52,
	0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x73, 0x73, 0x75, 0x65,
	0x64, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x69,
	0x73, 0x73, 0x75, 0x65, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x3a, 0x0a, 0x13, 0x47, 0x65,
	...
	0x77, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x22, 0x52, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e,
	...
	0x09, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x73, 0x42, 0x7b, 0x5a, 0x2c, 0x67, 0x69,
	...
	0x6e, 0x65, 0x72, 0x73, 0x2f, 0x76, 0x31, 0x3b, 0x76, 0x31, 0xca, 0x02, 0x1f, 0x47, 0x53, 0x6f,
	0x6c, 0x73, 0x5c, 0x50, 0x48, 0x50, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x5c, 0x51, 0x75, 0x65, 0x75,
	0x65, 0x72, 0x5c, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x5c, 0x76, 0x31, 0xe2, 0x02, 0x28, 0x47,
	0x53, 0x6f, 0x6c, 0x73, 0x5c, 0x50, 0x48, 0x50, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x5c, 0x51, 0x75,
	0x65, 0x75, 0x65, 0x72, 0x5c, 0x4f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x5c, 0x76, 0x31, 0x5c, 0x4d,
...
var file_queuer_owners_v1_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_queuer_owners_v1_messages_proto_goTypes = []interface{}{
	...
	(*GetOwnersRequest)(nil),         // 4: queuer.owners.v1.GetOwnersRequest
	(*GetOwnersResponse)(nil),        // 5: queuer.owners.v1.GetOwnersResponse
	(*ListStreamsRequest)(nil),       // 6: queuer.owners.v1.ListStreamsRequest
	(*ListStreamsResponse)(nil),      // 7: queuer.owners.v1.ListStreamsResponse
	(*RegisterConsumerRequest)(nil),  // 8: queuer.owners.v1.RegisterConsumerRequest
	(*RegisterConsumerResponse)(nil), // 9: queuer.owners.v1.RegisterConsumerResponse
	(*GetConsumersRequest)(nil),      // 10: queuer.owners.v1.GetConsumersRequest
	(*GetConsumersResponse)(nil),     // 11: queuer.owners.v1.GetConsumersResponse
	(*v1.Owner)(nil),                 // 12: queuer.entities.v1.Owner
	(*v1.Stream)(nil),                // 13: queuer.entities.v1.Stream
	(*v1.Consumer)(nil),              // 14: queuer.entities.v1.Consumer
}
var file_queuer_owners_v1_messages_proto_depIdxs = []int32{
	12, // 0: queuer.owners.v1.CreateOwnerResponse.owner:type_name -> queuer.entities.v1.Owner
	12, // 1: queuer.owners.v1.GetOwnerResponse.owner:type_name -> queuer.entities.v1.Owner
	12, // 2: queuer.owners.v1.GetOwnersResponse.owners:type_name -> queuer.entities.v1.Owner
	13, // 3: queuer.owners.v1.ListStreamsResponse.streams:type_name -> queuer.entities.v1.Stream
	14, // 4: queuer.owners.v1.GetConsumersResponse.consumers:type_name -> queuer.entities.v1.Consumer
...
func file_queuer_owners_v1_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_queuer_owners_v1_messages_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_queuer_owners_v1_messages_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_queuer_owners_v1_messages_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
